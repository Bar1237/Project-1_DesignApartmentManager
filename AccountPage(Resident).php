...
if(isset($_POST['update_button'])){
    ...
    if((empty($registerPassword))or(empty($fullName))or(empty($email))or(empty($phoneNumberOne))or(empty($phoneNumberTwo))or(empty($gender))){
    ...
    $sqlUpdate = "UPDATE `users` SET userPassword = '$registerPassword', fullName = '$fullName', email = '$email', phoneNumberOne = '$phoneNumberOne', phoneNumberTwo = '$phoneNumberTwo', gender = '$gender' WHERE userName = '$current_username'";
